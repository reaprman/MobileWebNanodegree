(function() {
    ...
    function RadioGroup(id) {
      ...
      // set button grouping to have role radiogroup
      ...
      for (var button of this.buttons) {
        ...
        // What about here?
        // give radio button role of radio
    ...
    RadioGroup.prototype.changeFocus = function() {
      ...
      // keep aria semantic element in-sync with visual state
      ...
      // keep aria element in-sync with visual state
